GOTO 10102401 WHERE :FORM_INTERFACE_NAME LIKE 'ZLIA_MIG%';
/*
*/
...
/*
Set OPEN */
SELECT STEPSTATUSDES ,'Y' INTO :NEWSTAT , :READY
...
SELECT STEPSTATUSDES INTO :AWAITDOC
FROM  ZCLA_ELSTATUSES
WHERE  0=0
AND    AWAITDRAWING = 'Y'
AND    :READY = 'Y'
...
, (:READY = 'Y' ?
(PROJACTS.ZCLA_HASFILE = 'Y' ? :NEWSTAT : :AWAITDOC)
: :NEWSTAT)
...
AND   ZCLA_ELSTATUSES.STEPSTATUSDES <>
( :READY = 'Y' ?
(PROJACTS.ZCLA_HASFILE = 'Y' ? :NEWSTAT : :AWAITDOC)
: :NEWSTAT ) ;
