...
/*
Insert New Rooms */
SELECT 'add rooms' , :ELEMENT , ROOM , COL , STYLE
FROM PROJACTS EL , ZCLA_ROOMS
WHERE 0=0
AND   ZCLA_ROOMS.HOUSETYPEID = EL.ZCLA_HOUSETYPEID
AND   EL.PROJACT = :ELEMENT
...
/*
*/
INSERT INTO ZCLA_PLOTROOMS(PROJACT , ROOM , COL , ZCLA_STYLE)
SELECT :ELEMENT , ROOM , COL , ZCLA_ROOMS.STYLE
FROM PROJACTS EL , ZCLA_ROOMS
WHERE 0=0
AND   ZCLA_ROOMS.HOUSETYPEID = EL.ZCLA_HOUSETYPEID
AND   EL.PROJACT = :ELEMENT
...
SELECT :GUID , :ELEMENT , :ROOM , :PART , :TQUANT , :STYLE , 'N' ,
'N'
FROM DUMMY ;
LOOP 2001 ;
LABEL 1999;
