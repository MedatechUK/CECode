...
SELECT 'ZCLA_ELACT/ZCLA_BUF1' , :ELEMENT
FROM DUMMY
WHERE :DEBUG = 1
...
/*
Insert Rooms */
INSERT INTO ZCLA_PLOTROOMS(GUID , PROJACT , ROOM , COL , ZCLA_STYLE , SUP)
SELECT ZCLA_ROOMS.GUID , :ELEMENT , ROOM , COL , ZCLA_ROOMS.STYLE , SUP
...
INSERT INTO ZCLA_PLOTQUOTE ( GUID
,    PROJACT
,    PROF 
,    KLINE 
,    ROOM 
...
:ROOM = :PART = 0 ;
:GID = '' ;
SELECT   GUID , PART , ROOM INTO :GID , :PART , :ROOM
FROM ZCLA_CONSUMERUNITS
WHERE CONSUMERUNIT = :CONSUMERUNIT
;
INSERT INTO ZCLA_PLOTCU( GUID , PROJACT , PART , ROOM )
SELECT :GID , :ELEMENT , :PART , :ROOM
FROM DUMMY ;
/*
*/
:NEWCU = 0;
