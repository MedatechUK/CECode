...
FROM ZCLA_ELSTATUSES
WHERE STEPSTATUSDES = :$.@ ;
GOSUB 100 WHERE :WASEDIT ='' AND :ISEDIT ='Y' ;
GOSUB 200 WHERE :WASEDIT ='Y' AND :ISEDIT ='' ;
/*
*/
SUB 100 ;
/* Open edit */
...
OPENPARTCOST , OPENLABCOST , OPENMILECOST , OPENPARTPRICE ,
OPENLABPRICE , OPENMILEPRICE , EXTRA)
SELECT PROJACT , SQL.USER , SQL.DATE , ZCLA_PARTCOST
,      ZCLA_LABCOST , ZCLA_MILEAGECOST, ZCLA_PARTPRICE ,
ZCLA_LABPRICE , ZCLA_MILEPRICE , :ISEXTRA
FROM PROJACTS
