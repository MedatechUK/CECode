...
WHERE :DEBUG = 1
FORMAT ADDTO :DEBUGFILE ;
GOTO 9990999 WHERE :FORM_INTERFACE <> 1
;
/*
...
GOTO 9990999 WHERE :COPIEDFROMTYPE = 0 ;
/*
Quit where locked */
GOTO 9990999
WHERE EXISTS (
...
LABEL 11;
:CONSUMERUNIT = :ROOM = :PART = :SORT = :COL = 0 ;
:ROOMDES = :STYLE = '' 
;
FETCH @CONSU INTO :CONSUMERUNIT 
,   :ROOM
,   :PART
,   :ROOMDES
,   :SORT
...
;
SELECT MAX(LINE) INTO :LN FROM GENERALLOAD;
INSERT INTO GENERALLOAD (LINE , RECORDTYPE, INT1 , INT2 , INT3 , TEXT1 , TEXT2 )
...
WHERE USER = SQL.USER ;
LABEL 9990999 ;
SELECT 'END ZCLA_HOUSETYPE/POST-INSERT'
FROM DUMMY
WHERE :DEBUG = 1
FORMAT ADDTO :DEBUGFILE ;
