...
.     'C' - Components 
*/
INSERT INTO ZCLA_POINTTMP  ( TYPE , FIXID , ROOM , PART , POINTS, CASHVALUE )
...
.      'S' - Subcontract Parts
*/
INSERT INTO ZCLA_POINTTMP  ( TYPE , FIXID , ROOM , PART , POINTS, CASHVALUE , SUBCON)
SELECT 'S'
,    ZCLA_PARTPOINTSPF.FIXID    
,    ZCLA_ROOMQUOTE.ROOM
,    PPROFITEMS.PART
...
AND    ZCLA_HOUSETYPE.HOUSETYPEID = 259
